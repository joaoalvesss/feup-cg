...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cube = new MyUnitCubeQuad(this, this.topTexture, this.bottomTexture, this.sideTexture, this.sideTexture, this.sideTexture, this.sideTexture);
    ...
    display() {
        ...
        else if (this.displayQuad)
            this.quad.display();
        else if(this.displayCube)
            this.cube.display();
