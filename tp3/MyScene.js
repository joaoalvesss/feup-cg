...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 8, 20); // 8 vertex, 20 stacks
        this.cylinder = new MyCylinder(this, 8, 20) // 8 vertex, 20 stacks
    ...
    initMaterials() {
        ...
        this.wood.setAmbient(0.2, 0.1, 0.05, 1.0); 
        this.wood.setDiffuse(0.64, 0.32, 0.16, 1.0); 
        this.wood.setSpecular(0.05, 0.05, 0.05, 1.0); 
